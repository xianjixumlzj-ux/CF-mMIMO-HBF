...
for bs_id in active_bs_ids:
    ...
    if cir_complex.ndim >= 3:
        ...
        target_samples = min(sample_num, cir_complex.size)
        per_sample_len = cir_complex.size // target_samples
        ...
        cir_3d = cir_complex[:target_samples * per_sample_len].reshape(target_samples, K_available, Mr)
        cir_cropped = cir_3d[:target_samples, :K, :Mr]
